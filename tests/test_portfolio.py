...
class TestPortfolioWebsite(unittest.TestCase):
    def setUp(self):
        ...
        self.html_file = self.root / "portfolio" / "index.html"
        self.css_file = self.root / "portfolio" / "styles.css"
        self.js_file = self.root / "portfolio" / "app.js"

    def test_files_exist(self):
        self.assertTrue(self.html_file.exists(), "portfolio/index.html does not exist")
        self.assertTrue(self.css_file.exists(), "portfolio/styles.css does not exist")
        self.assertTrue(self.js_file.exists(), "portfolio/app.js does not exist")
